...
parser.add_argument('--chkpt_pth', default='WESAD/', type=str)
parser.add_argument('--results_dir', default='WESAD/', type=str)
...
root_dir = '/home/group/dynamichetero_ts/WESAD/processed_wesad_activity/' #UPDATE PATH
dataset_cfg = WESAD()
